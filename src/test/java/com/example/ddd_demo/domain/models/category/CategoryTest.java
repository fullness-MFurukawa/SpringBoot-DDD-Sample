...
public class CategoryTest {
    ...
    void rehydrate_ShouldBuildEntityWithGivenIdAndName() {
        ...
        // エンティティを生成
        Category c = Category.rehydrate(existingId, name("雑貨"));
        // 商品Idが同じである
    ...
    void rehydrate_NullId_ShouldThrow() {
        assertThrows(DomainException.class, () 
            -> Category.rehydrate(null, name("雑貨")));
    }
    ...
    void rehydrate_NullName_ShouldThrow() {
        CategoryId existingId = id("ac413f22-0cf1-490a-9635-7e9ca810e544");
        assertThrows(DomainException.class, () 
            -> Category.rehydrate(existingId, null));
    }
    ...
    void equalsHashCode_ShouldUseIdentity() {
        ...
        Category a = Category.rehydrate(sameId, name("文房具"));
        Category b = Category.rehydrate(sameId, name("雑貨"));

        // 等価性（同一性）: 商品カテゴリIdが同じなら等価と評価される
        assertEquals(a, b);
        assertEquals(a.hashCode(), b.hashCode());
        // 別な商品カテゴリIdなら非等価
        Category c = Category.rehydrate(
