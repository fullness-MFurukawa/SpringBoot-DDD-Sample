...
public class StockTest {
    ...
    void rehydrate_ShouldBuildWithGivenIdAndQuantity() {
        ...
        Stock s = Stock.rehydrate(existing, q(20));
    ...
    void rehydrate_NullQuantity_ShouldThrow() {
        StockId existing = id("ac413f22-0cf1-490a-9635-7e9ca810e544");
        DomainException ex = assertThrows(DomainException.class, () -> Stock.rehydrate(existing, null));
        assertEquals("在庫数は必須です。", ex.getMessage());
    }
    ...
    void equalsHashCode_ShouldUseIdentity() {
        ...
        Stock a = Stock.rehydrate(same, q(10));
        Stock b = Stock.rehydrate(same, q(99));
        Stock c = Stock.rehydrate(id("8f81a72a-58ef-422b-b472-d982e8665292"), q(10));
